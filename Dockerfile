...
# Instalar Node.js y npm de manera más eficiente
RUN curl -fsSL https://deb.nodesource.com/setup_18.x | bash - && \
    apt-get install -y --no-install-recommends nodejs && \
    rm -rf /var/lib/apt/lists/*  # Limpieza para reducir el tamaño del contenedor

# Instalar sweetalert2 globalmente
RUN npm install -g sweetalert2 && npm cache clean --force  # Limpieza de caché de npm


RUN mv "$PHP_INI_DIR/php.ini-production" "$PHP_INI_DIR/php.ini"

# Copy app files from the app directory.
COPY ./src/main/resources/templates /var/www/html
